export const translations = {
  nl: {
    ...
    aiCoachSubtitle: 'Gepersonaliseerde observaties en vragen op basis van je teamdata',
    aiCoachGenerating: 'Inzicht genereren...',
    aiCoachGenerate: 'Genereer inzicht',
    aiCoachNewDataBadge: 'Nieuw inzicht beschikbaar',
    aiCoachFromCache: 'Gebaseerd op data van',
    aiCoachDailyLimit: 'generaties over vandaag',
    aiCoachDailyLimitReached: 'Daglimiet bereikt — morgen kun je weer genereren',
    aiCoachObservations: 'Observaties',
    aiCoachQuestions: 'Coachingvragen',
    aiCoachDataPoints: 'Onderbouwing',
    aiCoachReasoning: 'Waarom deze vraag',
    aiCoachError: 'Generatie mislukt. Probeer het later opnieuw.',
    crossTeamTitle: 'Cross-team Patronen',
    crossTeamSubtitle: 'Patronen over al je teams heen',
    crossTeamGenerate: 'Analyseer cross-team patronen',
    crossTeamGenerating: 'Teams analyseren...',
    crossTeamSuggestion: 'Suggestie',
    crossTeamTeams: 'Teams',
    crossTeamMinTeams: 'Cross-team analyse vereist minimaal 2 teams',
  ...
  en: {
    ...
    aiCoachTitle: 'AI Coach',
    aiCoachSubtitle: 'Personalized observations and questions based on your team data',
    aiCoachGenerating: 'Generating insight...',
    aiCoachGenerate: 'Generate insight',
    aiCoachNewDataBadge: 'New insight available',
    aiCoachFromCache: 'Based on data from',
    aiCoachDailyLimit: 'generations left today',
    aiCoachDailyLimitReached: 'Daily limit reached — generate again tomorrow',
    aiCoachObservations: 'Observations',
    aiCoachQuestions: 'Coaching Questions',
    aiCoachDataPoints: 'Supporting evidence',
    aiCoachReasoning: 'Why this question',
    aiCoachError: 'Generation failed. Please try again later.',
    crossTeamTitle: 'Cross-team Patterns',
    crossTeamSubtitle: 'Patterns across all your teams',
    crossTeamGenerate: 'Analyze cross-team patterns',
    crossTeamGenerating: 'Analyzing teams...',
    crossTeamSuggestion: 'Suggestion',
    crossTeamTeams: 'Teams',
    crossTeamMinTeams: 'Cross-team analysis requires at least 2 teams',
